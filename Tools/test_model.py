...
def create_temp_model(train):
    """Creates a temporary model that can be tested without overwriting existing saved models."""
...
def test_model(exercise, test, model):
...
def main():
    """
    Used to test a model without overwriting the existing saved models used in the main
    project.
    """
    ...
    model = create_temp_model(train)

    # Calculate model metrics.
    test_model(exercise, test, model)
